...
import { selectOptions } from '../../JobWizard.util'
...
const JobWizardParameters = ({ formState }) => {
    ...
    const [isParameterTypeDisabled, setIsParameterTypeDisabled] = useState(false)
    ...
    }, [formState.values.parameters])

    useEffect(() => {
        setIsParameterTypeDisabled(
            get(formState.values.parameters.hyperParameters, 'paramFile', '').length > 0
        )
    }, [formState.values.parameters.hyperParameters])
        ...
        <div className="job-wizard__parameters form">
            ...
            <div className="form-row">
                ...
                <div className="form-col-1">
                    <FormSelect
                        disabled={!get(formState.values, paramFilePath.split('.')) && !isParamFileDisabled || isParametersEditModeEnabled}
